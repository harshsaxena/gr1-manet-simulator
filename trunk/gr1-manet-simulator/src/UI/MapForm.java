...
public class MapForm extends JDialog implements ActionListener,
	...
	public MapForm(Myform owner, String title, boolean modal, Myform myForm)
		...
		// JLabel instructionLbl = new
		// JLabel("Please adjust Map's width and height");
		...
		Object[] array = { instruction, widthString, widthText, heightString,
				heightText };
	...
	public void propertyChange(PropertyChangeEvent e) {
		...
		if (isVisible()
			...
			if (okString.equals(value)) {
				...
				clearAndHide();
				this.myform.setXScale(mapWidth / this.myform.mapWidth);
				this.myform.setYScale(mapHeight / this.myform.mapHeight);
